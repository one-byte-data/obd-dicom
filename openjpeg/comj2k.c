...
void rawtoimage_fill8(int8_t *inputbuffer, int w, int h, int numcomps, opj_image_t *image)
{
...
void rawtoimage_fillu8(uint8_t *inputbuffer, int w, int h, int numcomps, opj_image_t *image)
{
...
void rawtoimage_fill16(int16_t *inputbuffer, int w, int h, int numcomps, opj_image_t *image)
{
...
void rawtoimage_fillu16(uint16_t *inputbuffer, int w, int h, int numcomps, opj_image_t *image)
{
...
void rawtoimage_fill32(int32_t *inputbuffer, int w, int h, int numcomps, opj_image_t *image)
{
...
void rawtoimage_fillu32(uint32_t *inputbuffer, int w, int h, int numcomps, opj_image_t *image)
{
 ...
 int sample_pixel, int bitsallocated, int sign)
{
  ...
  if (bitsallocated <= 8)
    ...
    if( sign )
      {
      rawtoimage_fill8((int8_t*)inputbuffer,w,h,numcomps,image);
      }
    else
      {
      rawtoimage_fillu8((uint8_t*)inputbuffer,w,h,numcomps,image);
      }
    }
    ...
    if( sign )
      {
      rawtoimage_fill16((int16_t*)inputbuffer,w,h,numcomps,image);
      }
    else
      {
      rawtoimage_fillu16((uint16_t*)inputbuffer,w,h,numcomps,image);
      }
    }
    ...
    if( sign )
      {
      rawtoimage_fill32((int32_t*)inputbuffer,w,h,numcomps,image);
      }
    else
      {
      rawtoimage_fillu32((uint32_t*)inputbuffer,w,h,numcomps,image);
      }
    }
  else
    {
